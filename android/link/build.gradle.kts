...
android {
    namespace = "com.tracking.familyorbit.link"
    compileSdk { version = release(37) }
    val configuredApiUrl = providers.gradleProperty("FAMILY_ORBIT_API_URL").orNull
	val firebaseAppId = providers.gradleProperty("FIREBASE_LINK_APP_ID").orElse("")
    ...
    defaultConfig {
        applicationId = "com.tracking.familyorbit.link"
        minSdk = 24
        targetSdk = 37
        versionCode = 1
        versionName = "0.1.0"
